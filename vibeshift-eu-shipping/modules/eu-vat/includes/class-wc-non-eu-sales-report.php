...
class WC_Non_EU_Sales_Report extends WC_Admin_Report {
	...
	public function get_export_button() {
		...
		?><a href="#" download="report-<?php echo esc_attr( $current_range ); ?>-<?php echo esc_attr( date_i18n( 'Y-m-d', current_time( 'timestamp' ) ) ); ?>.csv" class="export_csv" data-export="table">
			<?php esc_html_e( 'Export CSV', 'vibeshift-eu-shipping' ); ?>
		</a>
		<?php
	}
	...
	public function output_report() {
		$ranges = array(
			'prev_quarter' => __( 'Previous Quarter', 'vibeshift-eu-shipping' ),
			'last_quarter' => __( 'Last Quarter', 'vibeshift-eu-shipping' ),
			'quarter'      => __( 'This Quarter', 'vibeshift-eu-shipping' ),
		);
	...
	public function get_main_chart() {
		...
		<table class="widefat">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Country', 'vibeshift-eu-shipping' ); ?></th>
					<th><?php esc_html_e( 'Code', 'vibeshift-eu-shipping' ); ?></th>
					<th><?php esc_html_e( 'Tax Rate', 'vibeshift-eu-shipping' ); ?></th>
					<th class="total_row"><?php esc_html_e( 'Amount', 'vibeshift-eu-shipping' ); ?></th>
					<th class="total_row"><?php esc_html_e( 'Refunded Amount', 'vibeshift-eu-shipping' ); ?></th>
					<th class="total_row"><?php esc_html_e( 'Final Amount', 'vibeshift-eu-shipping' ); ?></th>
					<th class="total_row"><?php esc_html_e( 'Tax Amount', 'vibeshift-eu-shipping' ); ?></th>
					<th class="total_row"><?php esc_html_e( 'Tax Refunded Amount', 'vibeshift-eu-shipping' ); ?></th>
					<th class="total_row"><?php esc_html_e( 'Final Tax Amount ', 'vibeshift-eu-shipping' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php
				...
				if ( $found ) {
					...
					?>
					<tr>
						<th><strong><?php esc_html_e( 'Totals', 'vibeshift-eu-shipping' ); ?></strong></th>
						<th></th>
						<th></th>
					...
					?>
					<tr>
						<td colspan="9"><?php esc_html_e( 'No non-eu sales found in this period', 'vibeshift-eu-shipping' ); ?></td>
					</tr>
					<?php
				}
				?>
