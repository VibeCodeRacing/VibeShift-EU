		...
		<table class="widefat">
			<thead>
				<tr>
					...
					<th><?php esc_html_e( 'Shipping country', 'vibeshift-eu-shipping' ); ?></th>
					<th><?php echo esc_html( get_option( 'woocommerce_eu_vat_number_field_label', __( 'VAT number', 'vibeshift-eu-shipping' ) ) ); ?></th>
					<th class="total_row"><?php esc_html_e( 'Value', 'vibeshift-eu-shipping' ); ?></th>
				</tr>
			</thead>
			<?php if ( $ec_sales ) : ?>
				<tbody>
			...
			<?php else : ?>
				<tbody>
					<tr>
					<td colspan="3"><?php esc_html_e( 'No B2B EU orders found within this period.', 'vibeshift-eu-shipping' ); ?></td>
					</tr>
				</tbody>
			<?php endif; ?>
		</table>
