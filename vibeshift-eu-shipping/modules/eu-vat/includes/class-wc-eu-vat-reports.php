	...
	public static function display_hpos_incompatibility_notice() {
		...
		if ( current_user_can( 'activate_plugins' ) ) {
			...
			printf(
				...
				esc_html__( 'EU VAT Reports Not Available', 'vibeshift-eu-shipping' ),
				sprintf(
					...
					esc_html__( 'EU VAT reports are incompatible with the %1$sWooCommerce data storage features%3$s enabled on your store. Please enable %2$stable synchronization%3$s if you wish to use EU VAT reports.', 'vibeshift-eu-shipping' ),
