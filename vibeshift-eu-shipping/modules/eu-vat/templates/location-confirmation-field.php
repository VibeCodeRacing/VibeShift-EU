...
<p class="form-row location_confirmation terms">
	...
	<?php
		...
		echo wp_kses_post( sprintf( __( 'I am established, have my permanent address, or usually reside within <strong>%s</strong>.', 'vibeshift-eu-shipping' ), $countries[ $billing_country ] ) );
	?>
	</span>
	</label>
</p>
